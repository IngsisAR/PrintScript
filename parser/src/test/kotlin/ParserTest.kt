...
class ParserTest {
            ...
            astNode = VariableDeclaration(
                declarations = listOf(
                    VariableDeclarator(
                        ...
                        type = TypeReference(type = "number", start = 7, end = 13), init = null, start = 4, end = 13
                    )
                ),
                kind = "let", start = 0, end = 14
            )
        )
        ...
        val result = ASTBuilderSuccess(
            astNode = VariableDeclaration(
                declarations = listOf(
                    VariableDeclarator(
                        id = Identifier(name = "a", start = 4, end = 5),
                        type = TypeReference(type = "string", start = 7, end = 13), init = null, start = 4, end = 13
                    )
                ),
                kind = "let", start = 0, end = 14
            )
            ...
            astNode = VariableDeclaration(
                declarations = listOf(
                    VariableDeclarator(
                        ...
                        init = StringLiteral(value = "A", start = 16, end = 17), start = 4, end = 17
                    )
                ),
                kind = "let", start = 0, end = 18
            )
        )
        assertEquals(result, parser.parse(token))
    }
            ...
            astNode = VariableDeclaration(
                declarations = listOf(
                    VariableDeclarator(
                        id = Identifier(name = "a", start = 4, end = 5),
                        type = TypeReference(type = "string", start = 7, end = 13),
                        init = NumberLiteral(value = 5.toBigDecimal(), start = 16, end = 17), start = 4, end = 17
                    )
                ),
                kind = "let", start = 0, end = 18
            )
        ...
        val result = ASTBuilderSuccess(
            astNode = ExpressionStatement(
                expression = CallExpression(
                    ...
                    ), arguments = listOf(StringLiteral(value = "Hello world", start = 6, end = 19)), start = 0, end = 20
                ), start = 0, end = 21
            )
        )
        assertEquals(result, parser.parse(token))
        ...
        val result = ASTBuilderSuccess(
            astNode = ExpressionStatement(
                expression = CallExpression(
                    ...
                    ), arguments = listOf(NumberLiteral(value = 1.toBigDecimal(), start = 6, end = 7)), start = 0, end = 8
                ), start = 0, end = 9
            )
        )
        assertEquals(result, parser.parse(token))
    ...
    fun parseErrorForMisingColonInDeclaration() {
        ...
        val result =
            ASTBuilderFailure(errorMessage = "No valid statement found, errors: \nInvalid variable declaration: Not enough tokens for a variable declarator\nInvalid expression: No valid expression found\n")
        assertEquals(result, parser.parse(token))
    }
    ...
    fun parseErrorForMultipleColonInDeclaration() {
        ...
        val result =
            ASTBuilderFailure(
                errorMessage = "No valid statement found, errors: \n" +
    ...
    fun parseErrorForEmptyTokens() {
        ...
        val result = ASTBuilderFailure(errorMessage = "No valid statement found, errors: \nEmpty tokens\nEmpty tokens\n")
        assertEquals(result, parser.parse(token))
    }
    ...
    fun parseErrorFewerComasInDeclaration() {
        ...
        val result =
            ASTBuilderFailure(errorMessage = "No valid statement found, errors: \nInvalid variable declaration: Invalid declarator: No valid assignable expression found\nInvalid expression: No valid expression found\n")
        assertEquals(result, parser.parse(token))
    }
