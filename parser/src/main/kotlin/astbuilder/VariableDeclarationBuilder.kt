    ...
    override fun verify(): ASTBuilderResult {
        ...
        if (commaCount == 0) {
            ...
            if (variableDeclaratorResult is ASTBuilderFailure) {
                return ASTBuilderFailure("Invalid variable declarator: ${variableDeclaratorResult.errorMessage}")
            }
        ...
        var declaratorResult: ASTBuilderResult = ASTBuilderFailure("Invalid variable declarator")
